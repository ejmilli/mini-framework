...
import { createApp } from "../Framework/FrameworkCore.js";
import { renderHeader, renderMain, renderFooter, renderSidebar, renderInfo } from "./ComponentRenderer.js";
import { getFilteredTodos } from "./BusinessLogic.js";
...
app.setRenderFunction(renderApp).initialize();
